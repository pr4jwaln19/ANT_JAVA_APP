...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno){
        ...
        JLabel cnumber= new JLabel("XXXX-XXXX-XXXX-1904");
        cnumber.setFont(new Font("Raleway",Font.BOLD,22));
        cnumber.setBounds(330,300,260,30);
        add(cnumber);
        ...
        JLabel pmessage= new JLabel("Your 4 Digit PIN");
        pmessage.setFont(new Font("Raleway",Font.BOLD,12));
        pmessage.setBounds(100,400,300,20);
        add(pmessage);
        
        JLabel reqservices= new JLabel("Services Required : ");
        reqservices.setFont(new Font("Raleway",Font.BOLD,22));
        reqservices.setBounds(100,450,240,30);
        add(reqservices);
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource() == submit){
            ...
            String cardnumber = String.format("%012d", Math.abs(random.nextLong() % 1000000000000L));
            ...
            try {
                ...
                if (accountType.equals("")){
                    ...
                    String query1 = "INSERT INTO signupthree VALUES('" + formno + "','" + accountType.replace("'", "''") + "','" + cardnumber + "','" + pinnumber + "','" + facility + "')";
                    
                    String query2 = "INSERT INTO login VALUES('" + formno + "', '" + cardnumber + "', '" + pinnumber + "')";
                    
                    o.s.executeUpdate(query1);
                    o.s.executeUpdate(query2);
